  ...
  return (
    <section className="container flex flex-col gap-4 py-4">
      ...
      <ul className="">
        ...
        {Object.values(symbolsData).map(([name, price, amount_limit_usd, price_change, volume, bids, asks, order], index) => (
          <li key={index} className="flex justify-between border-b border-gray-300 py-2">
            ...
            <div className="w-28 border-r border-gray-300 px-2">{formatPrice(amount_limit_usd)} $</div>
