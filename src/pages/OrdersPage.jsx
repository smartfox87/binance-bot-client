    ...
    <section className="container flex flex-col gap-4 py-4">
      ...
      <ul>
        <li className="flex border-y border-gray-300 py-2">
          <div className="w-[5%] grow border-r border-gray-300 px-2">Symbol</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Id</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Status</div>
          <div className="w-[7%] grow border-r border-gray-300 px-2">Type</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Side</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Price</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Amount</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Distance</div>
          <div className="w-[5%] grow border-r border-gray-300 px-2">Avg price</div>
        ...
        {ordersData.map(({ symbol, id, status, type, side, price, avg_price, stop_price, orig_qty, executed_qty, update_time }) => (
          <li key={id} className="flex border-b border-gray-300 py-2">
            ...
            <div className="w-[7%] grow border-r border-gray-300 px-2">{type}</div>
            <div className="w-[5%] grow border-r border-gray-300 px-2">{side}</div>
            <div className="w-[5%] grow border-r border-gray-300 px-2">{formatPrice(price, "auto")} $</div>
            <div className="w-[5%] grow border-r border-gray-300 px-2">{formatPrice((price * orig_qty).toFixed(10), "auto")} $</div>
            <div className="w-[5%] grow border-r border-gray-300 px-2">
              {status !== "CANCELED" && symbolsData[symbol] ? ((Math.abs(price - symbolsData[symbol][1]) / symbolsData[symbol][1]) * 100).toFixed(5) : 0} %
            </div>
            <div className="w-[5%] grow border-r border-gray-300 px-2">{formatPrice(avg_price, "auto")} $</div>
